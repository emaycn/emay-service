...
public class UserApi {
    ...
    public SuperResult<String> add(String username, String realname, Long departmentId, String mobile, String email,
            String roleIds) {
        ...
        User currentUser = WebUtils.getCurrentUser();
        userService.add(username, realname, password, email, mobile, roleIds, departmentId, null, currentUser,
                Role.OPER_TYPE_OPER);
