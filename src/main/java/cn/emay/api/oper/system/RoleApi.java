 ...
 * @author frank
 */
@RequestMapping(value = "/o/role", method = RequestMethod.POST)
@RestController
@Api(tags = {"角色管理"})
public class RoleApi {
    ...
    public SuperResult<Page<Role>> rolelist(int start, int limit, String roleName) {
        Page<Role> userpage = roleService.findPage(start, limit, roleName, SystemType.OPER.getType());
    ...
    public Result add(String roleName, String remark, String resourceCodes) {
        ...
        String errorMsg = checkData(roleName, resourceCodes, remark, null, roleList, SystemType.OPER.getType());
        if (!StringUtils.isEmpty(errorMsg)) {
            return Result.badResult(errorMsg);
        }
        roleService.add(roleName, remark, roleList, SystemType.OPER.getType());
    ...
    public Result modify(Long roleId, String roleName, String remark, String resourceCodes) {
        ...
        List<RoleResourceAssign> roleList = new ArrayList<>();
        String errorMsg = checkData(roleName, resourceCodes, remark, roleId, roleList, SystemType.OPER.getType());
        if (!StringUtils.isEmpty(errorMsg)) {
            return Result.badResult(errorMsg);
        }
